...
class HMAEDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        vecs_reg = self.vecs_reg[index]
        vecs_reg = torch.FloatTensor(vecs_reg)
        ...
        # single_X_mrna = single_X_mrna[:100]
        # single_X_mirna = single_X_mirna[:100]
        # single_X_meth = single_X_meth[:100]

        return imgs, vecs_reg, seq_len, single_X_mrna, single_X_mirna, single_X_meth, \
