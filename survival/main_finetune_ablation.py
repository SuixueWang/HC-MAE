...
from util.data_ablation_loader import HMAEDataset
from model import models_ablation
from engine_finetune_ablation import train_one_epoch, evaluate
...
def main(args):
    ...
    for _k, data in data_cv_splits.items():
        ...
        model = models_ablation.__dict__[args.model](
