...
from pretrain_stage1.util.options import logger
...
def train_one_epoch(model: torch.nn.Module,
    ...
    for data_iter_step, (img, _) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        with torch.cuda.amp.autocast():
            loss = model(img, mask_ratio=args.mask_ratio)
