...
def get_args_parser_pretrain():
    ...
    parser.add_argument('--batch_size', default=630, type=int, # 630
    ...
    parser.add_argument('--finetune', default='./output_pretrain_dir/checkpoint-8.0-s4.pth',
    ...
    parser.add_argument('--warmup_epochs', type=int, default=0.01, metavar='N',
